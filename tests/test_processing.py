...
@pytest.mark.parametrize(
    "state, expected_ids", [("EXECUTED", [1, 4, 5]), ("CANCELED", [2]), ("PENDING", [3]), ("NONEXISTENT", [])]
)
...
def test_sort_by_date(sample_operations: List[Dict[str, Any]], reverse: bool, expected_ids_order: List[int]) -> None:
...
def test_sort_by_date_missing_date_key() -> None:
    operations_with_missing_date: List[Dict[str, Any]] = [
