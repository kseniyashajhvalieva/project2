...
def operations_data() -> List[Dict[str, Any]]:
    """
    Фикстура, возвращающая список словарей с данными операций.
    """
    return [
        {
            "id": 41428829,
...
def test_mask_account_card_account(operations_data: List[Dict[str, Any]]) -> None:
    """
...
def test_mask_account_card_card(operations_data: List[Dict[str, Any]]) -> None:
    """
...
def test_mask_account_card_invalid_input() -> None:
    """
    Тестирует обработку некорректного ввода для маскировки.
    """
...
def test_get_date_valid_format() -> None:
    """
    Тестирует корректное преобразование строки даты в заданный формат.
    """
...
def test_get_date_different_format() -> None:
    """
    Тестирует преобразование другой корректной строки даты.
    """
...
def test_get_date_invalid_format() -> None:
    """
    Тестирует обработку некорректных форматов строк даты.
    """
